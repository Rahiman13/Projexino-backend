...
const { getNewsletters, getNewsletterById, createNewsletter, updateNewsletter, deleteNewsletter, getMonthlyNewsletterCounts, getTotalNewslettersCount, sendNewsletter, scheduleBlogNewsletter, getScheduledNewsletters, cancelScheduledNewsletter, sendAnnouncement,
...
router.get('/:id', getNewsletterById); // Get all newsletters
...
router.get('/scheduled/count', getScheduledNewslettersCount);
router.post('/cancel/:id', cancelScheduledNewsletter);
router.get('/cancelled/count', getCancelledNewslettersCount);
router.get('/cancelled', getCancelledNewsletters);
